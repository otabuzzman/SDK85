...
TIMER   EQU      197 + 1 ; NUMBER OF INSTRUCTIONS MEASSURED IN T-STATES TO SKIP
...
;
; TIMER INTERRUPT (NMI) ENTRY POINT
;
        ORG     66H
        JMP     STP25    ; BACK TO SINGLE STEP ROUTINE
;
...
BRTAB   EQU      08FAH   ; LOCATION OF START OF BRANCH TABLE IN ROM
